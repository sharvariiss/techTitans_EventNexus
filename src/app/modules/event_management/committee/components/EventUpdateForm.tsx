...
type UpdateEventModalProps = {
  show: boolean;
  onClose: () => void;
  eventId: string | null; // Add eventId to the type
};

const EventUpdateForm: React.FC<UpdateEventModalProps> = ({ show, onClose, eventId }) => {
            ...
            <div className='modal-dialog modal-dialog-centered mw-750px'>
              <div className='modal-content'>
                <div className='modal-header'>
                  <h2 className='fw-bold'>Update Event</h2>
                  <div
